# DayQ — مدیریت روزانه برای مدرپ

> اپ آفلاین فارسی برای برنامه‌ریزی روزانه — ساخته‌شده برای مدرپ‌های میدانی دارویی
...
```
گزارش هفتگی پنجشنبه ۱۴ تیر #کوبل
→  task با deadline، پروژه کوبل
```
...
| کاربر | کاربرد |
|---|---|
| **مدرپ دارویی** | برنامه‌ریزی ویزیت، تولد پزشکان، گزارش روزانه |
| **کاربر فارسی‌زبان** | تقویم شمسی، یادآوری، پروژه شخصی |
| **کاربر آفیس** | task مشترک، sync چنددستگاهی |
...
- **تقویم شمسی کامل** — ماهانه/هفتگی/فهرست با تعطیلات رسمی
- **پروژه‌ها** — دسته‌بندی با نشانگر پیشرفت
- **مناسبت‌ها** — تولد، سالگرد، روزهای پزشکی، یادآوری چند بازه‌ای
